...
const PitAssignmentsPage: React.FC = () => {
  ...
  const handlePushAssignments = () => {
    ...
    toast.success(
      `Pushed pit assignments to ${readyConnectedScoutsCount} connected scout${readyConnectedScoutsCount === 1 ? '' : 's'}`
    );
  };
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            {availableScouts.length === 0 &&
              ' Please add scouts or connect scouts over WiFi to create assignments.'}
          </AlertDescription>
        </Alert>
      )}
    </div>
