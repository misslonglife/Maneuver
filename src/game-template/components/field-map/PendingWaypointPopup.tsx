...
export function PendingWaypointPopup({
  ...
  const [pendingClimbLevel, setPendingClimbLevel] = useState<ClimbLevel | undefined>(climbLevel);
  ...
  const climbTimeShortcutLabel = useMemo(
    () =>
      climbTimeShortcutKeys
        .slice(0, climbTimePresets.length)
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (isClimb && isSelectingClimbTime) {
        const presetIndex = climbTimeShortcutKeys
          .slice(0, climbTimePresets.length)
          .indexOf(normalizedKey);
        if (presetIndex >= 0) {
  ...
  return (
    ...
    >
      ...
      >
                    ...
                    >
                      <span className="inline-flex items-center justify-center gap-1.5">
                        <Kbd className="h-5 px-1.5 text-[10px]">
                          {climbTimeShortcutKeys[index]?.toUpperCase()}
                        </Kbd>
        ...
        {isClimb && (
          <p className="px-3 text-[11px] text-muted-foreground text-center">
            {isSelectingClimbTime ? (
              <>
                Keys:{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">{climbTimeShortcutLabel}</Kbd>{' '}
                preset, type time, <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd>{' '}
                next, <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
              </>
            ) : requiresClimbLocation && !climbLocation ? (
              <>
                Keys: <Kbd className="h-4 px-1 text-[9px] align-middle">A</Kbd> side,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">F</Kbd> middle,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd> confirm,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
              </>
            ) : climbWithLevels && !climbLevel ? (
              <>
                Keys: <Kbd className="h-4 px-1 text-[9px] align-middle">A</Kbd> L1,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">S</Kbd> L2,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">D</Kbd> L3,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd> confirm,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
              </>
            ) : !skipClimbOutcomeSelection ? (
              allowClimbFail ? (
                <>
                  Keys: <Kbd className="h-4 px-1 text-[9px] align-middle">A</Kbd> success,{' '}
                  <Kbd className="h-4 px-1 text-[9px] align-middle">F</Kbd> fail,{' '}
                  <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd> confirm,{' '}
                  <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
                </>
              ) : (
              ...
              <>
                Keys: <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd> confirm,{' '}
                <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
              </>
            )}
          </p>
        ...
        {!isClimb && (
          <p className="px-3 text-[11px] text-muted-foreground text-center">
            Keys: <Kbd className="h-4 px-1 text-[9px] align-middle">Q/W/E/R/T</Kbd> +{' '}
            <Kbd className="h-4 px-1 text-[9px] align-middle">A/S/D/F/G</Kbd> select amount,{' '}
            <Kbd className="h-4 px-1 text-[9px] align-middle">Z</Kbd> undo,{' '}
            <Kbd className="h-4 px-1 text-[9px] align-middle">Space</Kbd> confirm,{' '}
            <Kbd className="h-4 px-1 text-[9px] align-middle">Esc</Kbd> cancel
          </p>
        )}
