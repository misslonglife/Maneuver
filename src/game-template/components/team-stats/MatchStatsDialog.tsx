                    ...
                    <div className="p-4 border rounded space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Excluding a match keeps the record but removes it from aggregate team
                          stats.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label
                          htmlFor={`ignore-${matchData.id ?? matchData.matchNumber ?? 'match'}`}
                        >
        ...
        <AlertDialogPortal>
          ...
          <AlertDialogContent className="z-220">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Delete Team {matchData.teamNumber ?? '?'} Match {matchData.matchNumber ?? '?'}? This
                cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel className="p-2" disabled={isDeleting}>
                Cancel
              </AlertDialogCancel>
              <Button
                type="button"
