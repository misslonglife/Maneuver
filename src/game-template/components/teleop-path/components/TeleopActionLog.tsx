...
function getDefenseEffectivenessLabel(
  effectiveness?: PathWaypoint['defenseEffectiveness']
): string {
                  ...
                  >
                    ...
                    {action.type === 'defense' && (
                      <div className="text-xs text-muted-foreground">
                        Defended Team {action.defendedTeamNumber ?? 'Unknown'} •{' '}
                        {getDefenseEffectivenessLabel(action.defenseEffectiveness)}
                      </div>
                    )}
                  </div>
                );
