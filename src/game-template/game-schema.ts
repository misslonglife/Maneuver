...
export const strategyColumns = {
  ...
  points: {
    ...
    statboticsTotalPoints: {
      label: 'Statbotics EPA (Total Points)',
      visible: false,
      numeric: true,
    },
    statboticsAutoPoints: { label: 'Statbotics EPA (Auto Points)', visible: false, numeric: true },
    statboticsTeleopPoints: {
      label: 'Statbotics EPA (Teleop Points)',
      visible: false,
      numeric: true,
    },
    statboticsEndgamePoints: {
      label: 'Statbotics EPA (Endgame Points)',
      visible: false,
      numeric: true,
    },
  ...
  teleop: {
    ...
    statboticsTeleopFuel: {
      label: 'Statbotics EPA (Teleop+Endgame Fuel)',
      visible: false,
      numeric: true,
    },
  ...
  endgame: {
    ...
    statboticsEndgameTower: {
      label: 'Statbotics EPA (Endgame Tower)',
      visible: false,
      numeric: true,
    },
    ...
    'endgame.climbFromSideRate': {
      label: 'Endgame Climb From Side %',
      visible: true,
      numeric: true,
      percentage: true,
    },
    'endgame.climbFromMiddleRate': {
...
export const strategyPresets: Record<string, string[]> = {
  ...
  endgame: [
    ...
    'rawValues.endgameClimbStartTimeSec',
    'endgame.climbAttempts',
    'endgame.climbL1Rate',
    'endgame.climbL1Attempts',
    'endgame.climbL2Rate',
    'endgame.climbL2Attempts',
    'endgame.climbL3Rate',
    'endgame.climbL3Attempts',
    'endgame.climbFromSideRate',
    'endgame.climbFromMiddleRate',
  ],
